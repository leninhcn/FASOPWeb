  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "/langtrans",
        name: "langtrans",
        component: () => import("../components/MesUtitils/langTrans.vue"),
      },
      {
        path: "/erdash",
        name: "erdash",
        component: () => import("../components/FATPkanban/Dashboard.vue"),
      },
      {
        path: "/lgdash",
        name: "lgdash",
        component: () =>
          import("../components/FATPkanban/LOGI/DashboardLOGI.vue"),
      },
      {
        path: "/nkdash",
        name: "nkdash",
        component: () =>
          import("../components/FATPkanban/LOGI/DashboardNK.vue"),
      },
      {
        path: "/ratecommon",
        name: "ratecommon",
        component: () => import("../components/FATPkanban/PassRateCommon.vue"),
      },
      {
        path: "/grpifo",
        name: "grpifo",
